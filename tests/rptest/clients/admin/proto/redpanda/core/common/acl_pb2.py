...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ACLRESOURCE']._serialized_end = 347
    _globals['_ACLPATTERN']._serialized_start = 350
    _globals['_ACLPATTERN']._serialized_end = 486
    _globals['_ACLOPERATION']._serialized_start = 489
    _globals['_ACLOPERATION']._serialized_end = 850
    _globals['_ACLPERMISSIONTYPE']._serialized_start = 853
    _globals['_ACLPERMISSIONTYPE']._serialized_end = 999