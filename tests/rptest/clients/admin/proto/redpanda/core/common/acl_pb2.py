...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ACLRESOURCE']._serialized_start = 99
    _globals['_ACLRESOURCE']._serialized_end = 263
    _globals['_ACLPATTERN']._serialized_start = 266
    _globals['_ACLPATTERN']._serialized_end = 402
    _globals['_ACLOPERATION']._serialized_start = 405
    _globals['_ACLOPERATION']._serialized_end = 766
    _globals['_ACLPERMISSIONTYPE']._serialized_start = 768
    _globals['_ACLPERMISSIONTYPE']._serialized_end = 894