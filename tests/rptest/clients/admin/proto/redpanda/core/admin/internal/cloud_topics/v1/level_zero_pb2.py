...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_STATUS']._serialized_end = 1668
    ...
    _globals['_LEVELZEROSERVICE']._serialized_start = 1671
    _globals['_LEVELZEROSERVICE']._serialized_end = 2764