...
class MarkedFunctionExpander:
    ...
    def __init__(self, session_context: Incomplete | None = ..., module: Incomplete | None = ..., cls: Incomplete | None = ..., function: Incomplete | None = ..., file: Incomplete | None = ..., cluster: Incomplete | None = ...) -> None: ...
