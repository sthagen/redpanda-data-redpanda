...
from ducktape.mark.resource import CLUSTER_SIZE_KEYWORD as CLUSTER_SIZE_KEYWORD, CLUSTER_SPEC_KEYWORD as CLUSTER_SPEC_KEYWORD
...
from ducktape.tests.loggermaker import LoggerMaker as LoggerMaker, close_logger as close_logger
...
class Test(TemplateRenderer):
    ...
    def __init__(self, test_context: TestContext, *args: list[Any],
    ...
    def mark_for_collect(self,
                         service,
                         log_name: Incomplete | None = ...) -> None:
        ...

    def mark_no_collect(self,
                        service,
                        log_name: Incomplete | None = ...) -> None:
        ...
