...
class RemoteCommandError(RemoteAccountError):
    ...
    def __init__(self, account: Any, cmd: str, exit_status: int,
                 msg: str) -> None:
        ...
...
class RemoteAccount:
    ...
    def __init__(self,
                 ...
                 ssh_exception_checks: list = ...) -> None:
        ...
    ...
    def wait_for_http_service(self,
                              port: int,
                              headers: Any,
                              timeout: int = ...,
                              path: str = ...) -> None:
    ...
    def ssh_capture(self,
                    cmd: str,
                    allow_fail: bool = ...,
                    callback: Optional[Callable[[str], Any]] = ...,
                    combine_stderr: bool = ...,
                    timeout_sec: Optional[float] = ...) -> 'SSHOutputIter':
        ...
    ...
    def ssh_output(self,
                   ...
                   allow_fail: bool = ...,
                   combine_stderr: bool = ...,
                   timeout_sec: Optional[float] = ...) -> bytes:
        ...
    ...
    def kill_process(self,
                     process_grep_str: str,
                     clean_shutdown: bool = ...,
                     allow_fail: bool = ...) -> None:
        ...

    def java_pids(self, match: str) -> list[int]:
        ...

    def kill_java_processes(self,
                            match: str,
                            clean_shutdown: bool = ...,
                            allow_fail: bool = ...) -> None:
        ...
