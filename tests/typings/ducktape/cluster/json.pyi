...
from ducktape.cluster.linux_remoteaccount import LinuxRemoteAccount as LinuxRemoteAccount
from ducktape.cluster.node_container import NodeContainer as NodeContainer
from ducktape.cluster.windows_remoteaccount import WindowsRemoteAccount as WindowsRemoteAccount
from ducktape.command_line.defaults import ConsoleDefaults as ConsoleDefaults

class JsonCluster(Cluster):
    def __init__(self, cluster_json: Incomplete | None = ..., *args, **kwargs) -> None: ...
    @staticmethod
